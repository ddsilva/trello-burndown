const Burndown = ((global) => {
  //{done: Number, extras: Number}
  function Burndown(options = {}) {
    const SPRINT_START_DAY      = options.sprintStartDay    || '01/01', //month/day
          SPRINT_DAYS           = options.sprintDays        || 10, //number
          INITIAL_SPRINT_TASKS  = options.initialSprintTaks || 20, //number
          INITIAL_SPRINT_POINTS = options.initialSprintPoints || 30, //number
