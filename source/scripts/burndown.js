const startburndown = (global) => {
  ...
  const SPRINT_START_DAY = global.startDate; //month/day
  const SPRINT_DAYS = global.sprintDays;
  const INITIAL_SPRINT_TASKS = global.cardLength;
